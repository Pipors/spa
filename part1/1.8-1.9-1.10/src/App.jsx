...
/*const Statistics = (props) => {    
    // The Statistics component uses destructuring to extract the properties 'good', 'neutral', 'bad', and 'all' from the props object.  
    // This simplifies the code by allowing direct access to these values without needing to prefix them with 'props.'.  
    // When calling the Statistics component, ensure that the parent component passes these properties explicitly, like so:  
...
const Statistics = (props) => {
    ...
    // <Statistics {...props} /> , FYI this methode can be used if you define an props object in the App component see Line: 185
